...
func init() {
	proto.RegisterType((*HelloRequest)(nil), "srv.greeter.HelloRequest")
	proto.RegisterType((*HelloResponse)(nil), "srv.greeter.HelloResponse")
}
...
var fileDescriptor_e585294ab3f34af5 = []byte{
	...
	0x2d, 0x49, 0x2d, 0xd2, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0xe2, 0x2e, 0x2e, 0x2a, 0xd3, 0x83,
	...
	0x81, 0xd9, 0x4a, 0xda, 0x5c, 0xbc, 0x50, 0x35, 0xc5, 0x05, 0xf9, 0x79, 0xc5, 0xa9, 0x42, 0x52,
	0x5c, 0x1c, 0x60, 0xfd, 0x99, 0x79, 0xe9, 0x12, 0x4c, 0x60, 0x85, 0x70, 0xbe, 0x91, 0x37, 0x17,
	0xbb, 0x3b, 0xc4, 0x6c, 0x21, 0x07, 0x2e, 0x56, 0xb0, 0x3e, 0x21, 0x49, 0x3d, 0x24, 0x2b, 0xf5,
	0x90, 0xed, 0x93, 0x92, 0xc2, 0x26, 0x05, 0xb1, 0x46, 0x89, 0x21, 0x89, 0x0d, 0xec, 0x62, 0x63,
	0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0x52, 0x2b, 0x76, 0x57, 0xc2, 0x00, 0x00, 0x00,
}
...
func (c *greeterClient) Hello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/srv.greeter.Greeter/Hello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Greeter_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/srv.greeter.Greeter/Hello",
	}
...
var _Greeter_serviceDesc = grpc.ServiceDesc{
	ServiceName: "srv.greeter.Greeter",
